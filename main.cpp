...
int main()
{
    ...
    //volatile logic l5 = gpio::D2.read();
    //volatile logic l6 = gpio::D3.readOutput();
    //gpio::D3.toggle();
    ...
    //usart::Usart0.onWriteReady([](const usart::UsartObject& u){
    //    u.write('b');
    //});
    //isr::enable();
    ...
    //timer::Timer0.onOverflow([](const timer::Timer0Object& t) {
    //    gpio::D13.toggle();
    //});
    //isr::enable();
    ...
    //timer::Timer1.onMatchA([](const timer::Timer1Object& t) {
    //    gpio::D13.toggle();
    //});
    //isr::enable();
